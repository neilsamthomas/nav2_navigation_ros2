...
#include "custom_interface/srv/detail/my_service_message__rosidl_typesupport_fastrtps_c.h"
...
using _MyServiceMessage_Request__ros_msg_type = custom_interface__srv__MyServiceMessage_Request;
...
size_t get_serialized_size_custom_interface__srv__MyServiceMessage_Request(
  const void * untyped_ros_message,
...
static uint32_t _MyServiceMessage_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface__srv__MyServiceMessage_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interface
size_t max_serialized_size_custom_interface__srv__MyServiceMessage_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MyServiceMessage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interface__srv__MyServiceMessage_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interface, srv, MyServiceMessage_Request)() {
...
using _MyServiceMessage_Response__ros_msg_type = custom_interface__srv__MyServiceMessage_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: navigation_successful
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interface
size_t get_serialized_size_custom_interface__srv__MyServiceMessage_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MyServiceMessage_Response__ros_msg_type * ros_message = static_cast<const _MyServiceMessage_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface__srv__MyServiceMessage_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interface
size_t max_serialized_size_custom_interface__srv__MyServiceMessage_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MyServiceMessage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interface__srv__MyServiceMessage_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interface, srv, MyServiceMessage_Response)() {
...
// already included above
// #include "custom_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_interface/srv/my_service_message.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interface, srv, MyServiceMessage)() {
